...
namespace WebServices
{
    internal class HeaderService : DefaultDataService, IHeaderService
    {
        ...
        public HeaderService(IHeaderMenuSetRepository menuRepository, IHeaderSloganRepository sloganRepository)
        {
        ...
        {
            var newUsedMenu = await _menuRepository.GetEntity(id);
            if (newUsedMenu == null)
            {
                return;
            }
        ...
        {
            var entity = await _menuRepository.GetEntity(data.Id);
        ...
        {
            var entity = await _menuRepository.GetEntity(id);
            if (entity != null)
            {
                await _menuRepository.RemoveEntityAsync(entity);
            }
        }
        ...
        {
            var entity = await _sloganRepository.GetEntity(id);
            if (entity == null) 
            {
                return null;
            }
        ...
        {
            var entity = await _sloganRepository.GetEntity(data.Id);
        ...
        public async Task RemoveSloganToDbAsync(int id)
        {
            ...
            if (entity != null)
            {
                await _sloganRepository.RemoveEntityAsync(entity);
            }
        }
    }
}
