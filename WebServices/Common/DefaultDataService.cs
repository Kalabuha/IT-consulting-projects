...
namespace WebServices.Common
{
    ...
    {
        protected readonly string _directoryDefaultTextFiles = @"..\WebServices\Common\DefaultData\txt";
        protected readonly string _directoryDefaultImageFiles = @"..\WebServices\Common\DefaultData\img";
