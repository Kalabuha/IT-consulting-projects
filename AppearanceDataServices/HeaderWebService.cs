...
namespace AppearanceDataServices
{
    internal class HeaderWebService : DefaultDataService, IHeaderService
    {
        ...
        public async Task<MenuData> GetUsedMenuDataAsync()
        {
            ...
            {
                Id = 0,
                Main = nameof(MenuData.Main),
                Services = nameof(MenuData.Services),
                Projects = nameof(MenuData.Projects),
                Blogs = nameof(MenuData.Blogs),
                Contacts = nameof(MenuData.Contacts),
