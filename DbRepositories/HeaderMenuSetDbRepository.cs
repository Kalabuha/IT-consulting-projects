...
{
    internal class HeaderMenuSetDbRepository : BaseDbRepository<MenuEntity>, IHeaderMenuSetRepository
    {
        public HeaderMenuSetDbRepository(DbContextProfiСonnector context) : base(context) {}
